    ...
    return createPortal(
        <div className="fixed inset-0 z-10000 w-screen h-screen flex items-center justify-center p-4 bg-background/80 backdrop-blur-md animate-in fade-in duration-300">
            <div className="relative w-full max-w-md bg-card/95 border border-red-500/20 shadow-2xl shadow-red-500/10 rounded-[32px] overflow-hidden animate-in zoom-in-95 duration-300">
                ...
                <div className="absolute top-0 left-0 w-full h-1.5 bg-linear-to-r from-red-600 via-red-500 to-orange-500" />
                ...
                <div className="p-8 sm:p-10 relative z-10 flex flex-col items-center text-center">
                    ...
                    <div className="mb-8 mt-2">
                        <div className="relative group mx-auto">
                            ...
                            <div className="relative h-20 w-20 rounded-[28px] bg-linear-to-br from-card to-red-500/10 flex items-center justify-center text-red-500 border border-red-500/20 shadow-[0_8px_32px_-8px_rgba(239,68,68,0.3)] inset-0 group-hover:scale-110 transition-transform duration-500">
                    ...
                    <div className="space-y-4 flex flex-col items-center">
                        ...
                        <div className="h-1 w-12 bg-linear-to-r from-red-500/0 via-red-500/50 to-red-500/0 rounded-full" />
                    ...
                    <div className="flex flex-col-reverse sm:flex-row gap-4 mt-12 w-full">
                        ...
                        <Button
                            ...
                            onClick={onConfirm}
                            isLoading={isLoading}
                            className="flex-1 font-black leading-none tracking-wide text-sm py-6 rounded-2xl bg-linear-to-b from-red-500 to-red-600 hover:from-red-400 hover:to-red-500 text-white shadow-[0_0_40px_-10px_rgba(239,68,68,0.5)] hover:shadow-[0_0_60px_-15px_rgba(239,68,68,0.6)] border border-red-400/20 transition-all duration-300 transform hover:-translate-y-[2px] active:translate-y-px"
                        >
                            Confirm Delete
                        </Button>
                    </div>
