    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-6xl mx-auto">
            ...
            <div className="max-w-md">
                <div className="relative">
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 bg-card border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all font-medium text-sm"
                    />
            ...
            <div className="glass-panel rounded-2xl overflow-hidden shadow-sm">
                ...
                <TeamTable refreshTrigger={refreshKey} searchQuery={searchQuery} />
            </div>
